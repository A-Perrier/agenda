...
const rightIcon = (fillColor = null) => {
  return <svg className="icon" width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
  <rect x="0.5" y="0.5" width="25" height="25" rx="2.5" fill={ fillColor ? fillColor : '#F9FBFF' } stroke="#D2DEEE"/>
